...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("libraries/swf-library/8.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("libraries/swf-library/swf-library.dat");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("libraries/swf-library.json");
		types.push (lime.Assets.AssetType.TEXT);
	...
	public static function main () {
		...
		config = {
			...
			height: Std.int (0),
			orientation: "",
			packageName: "com.vretta.mathematic.depp",
			resizable: true,
			stencilBuffer: true,
			title: "Depp001",
			version: "1.0.0",
